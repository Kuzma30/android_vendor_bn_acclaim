...
VENDOR_BLOB := vendor/bn/acclaim/proprietary
...
PRODUCT_COPY_FILES += \
    ...
    $(VENDOR_BLOB)/firmware/ducati-m3.bin:system/etc/firmware/ducati-m3.bin

# Prebuilt /system/lib
PRODUCT_COPY_FILES += \
    $(VENDOR_BLOB)/lib/libidme.so:system/lib/libidme.so \
    $(VENDOR_BLOB)/lib/hw/sensors.acclaim.so:system/lib/hw/sensors.acclaim.so \
